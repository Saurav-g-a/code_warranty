...
function Footer() {
    return (
        <div className='bg-headerBackground bg-cover bg-no-repeat pt-12'>
            ...
            <p className='text-center text-[#95AAAD] Gilroy text-lg py-8'>Since 2024, CodeWarranty has been a leading web and mobile app development agency, <br /> specializing in creating custom solutions for businesses.</p>
            ...
            <div className=' text-center py-3'>
                <p className='text-center Brockmann text-white'>© 2025 CodeWarranty. All Rights Reserved. </p>
            </div>
        </div>
    )
}
